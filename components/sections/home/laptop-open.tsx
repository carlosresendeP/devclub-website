...
export function LaptopOpen() {
  ...
  useEffect(() => {
    ...
    const seamGlow = seamGlowRef.current;
    ...
    if (reducedMotion) {
      ...
      if (seamGlow) seamGlow.style.opacity = "0";
    ...
    if (seamGlow) seamGlow.style.opacity = "1";
    ...
    const context = gsap.context(() => {
      ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          ...
          if (seamGlow) seamGlow.style.opacity = String(1 - clamp01(progress / SEAM_FADE_END));
